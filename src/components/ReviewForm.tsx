      ...
      <div className="relative mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-400 max-w-xl mx-auto text-sm">
            Your honest feedback helps other Kenyan businesses find the right partner. It takes less than a minute.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            {status === 'success' ? (
              <motion.div
                ...
                className="rounded-2xl border border-green-500/30 bg-green-900/20 p-12 text-center flex flex-col items-center gap-4"
              >
              ...
              <motion.form
                ...
                className="rounded-2xl border border-white/10 bg-slate-800/60 p-8 space-y-5"
              >
                {/* Header with Google icon */}
                <div className="flex items-center gap-3 mb-1">
                  <div className="h-9 w-9 rounded-xl bg-white flex items-center justify-center shadow-md flex-shrink-0">
                    <GoogleLogo />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-white leading-tight">Leave a Review</h3>
                    <p className="text-xs text-slate-400">Moderated before publishing. Your details are kept private.</p>
                  </div>
                </div>
