      ...
      <div id="review-form" className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-400 max-w-xl mx-auto">
            Your honest feedback helps other Kenyan businesses find the right partner. Leave a review below — it takes less than a minute.
          </p>
        </motion.div>

        <div className="grid md:grid-cols-5 gap-8 items-start">
          {/* Left: Google Review CTA */}
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="md:col-span-2 rounded-2xl border border-white/10 bg-slate-800/60 p-7 flex flex-col gap-5"
          >
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-red-400 mb-1">Google Reviews</p>
              <h3 className="text-lg font-bold text-white mb-2">Leave a Google Review</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                Google reviews boost our visibility and help other businesses in Nairobi and Kiambu County discover us.
              </p>
            </div>
            <div className="flex gap-0.5">
              ...
              <span className="ml-2 text-xs text-slate-400 font-medium self-center">5-star review</span>
            </div>
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="flex items-center justify-center gap-2 rounded-xl bg-[#0070c0] hover:bg-[#005fa3] text-white font-semibold px-5 py-3 text-sm shadow-lg shadow-blue-900/30 transition-colors"
            >
            ...
            <AnimatePresence mode="wait">
              {status === 'success' ? (
                <motion.div
                  ...
                  className="rounded-2xl border border-green-500/30 bg-green-900/20 p-10 text-center flex flex-col items-center gap-4"
                >
                  <CheckCircle className="h-14 w-14 text-green-400" />
                  <h3 className="text-xl font-bold text-white">Thank you for your review!</h3>
                  <p className="text-slate-400 max-w-sm">
                    Your review has been submitted and will appear on this page after our team approves it. We really appreciate your time.
                  </p>
                  <button
                    onClick={() => {
                      setStatus('idle');
                ...
                <motion.form
                  ...
                  className="rounded-2xl border border-white/10 bg-slate-800/60 p-7 space-y-5"
                >
                  <h3 className="text-lg font-bold text-white">Leave a review on our website</h3>
                  <p className="text-xs text-slate-400">
                    Reviews are moderated before publishing. Your details are kept private.
                  </p>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Director, Accountant, Owner"
                      className="w-full rounded-xl border border-white/10 bg-slate-700/50 text-white placeholder-slate-500 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-500/50 transition"
                    />
                  </div>
