...
const themeConfig: Record<ShowcaseTheme, {
  ...
  about: {
    ...
    imageCaption: "Kenya's certified TallyPrime implementation team",
    stat: '10+ Years',
  ...
  features: {
    ...
    dotColor: '#0ea5e9',
    imageUrl: '/images/services-african-consultation.webp',
    imageCaption: 'End-to-end implementation & support',
    stat: '5-Step',
    statLabel: 'Implementation process',
    alt: 'TallyPrime ERP inventory and business analytics dashboard',
  },
  faq: {
    ...
    dotColor: '#8b5cf6',
    imageUrl: '/images/faq-african-support.webp',
    imageCaption: 'Get answers from our certified consultants',
    stat: '<1hr',
    statLabel: 'Support response',
    alt: 'Optimum Prime Solutions customer support and TallyPrime consulting',
  },
  testimonials: {
  ...
  contact: {
    ...
    dotColor: '#dc2626',
    imageUrl: '/images/contact-office-setup.webp',
