...
Join 500+ Kenyan businesses already running smarter with TallyPrime, cloud hosting, and EOS®. Get a free, personalized demo from Kenya's certified TallyPrime partner.
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link to="/contact" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="rounded-xl bg-slate-800 px-8 py-4 text-sm font-bold text-slate-900 shadow-xl shadow-slate-300/30 hover:bg-slate-100 transition-all hover:scale-105">
                Request Free Demo
              </Link>
              <a href="https://tallysolutions.com/ssa/download/" target="_blank" rel="noreferrer"
                className="inline-flex items-center gap-3 rounded-xl border border-white/20 bg-slate-800/90 px-6 py-4 text-sm font-bold text-slate-900 backdrop-blur-sm hover:bg-slate-100 transition-all">
