      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 font-sans">
        ...
        >
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-extrabold text-white leading-tight">
            TallyPrime Editions, Cloud Hosting &amp; Business Solutions
          </h2>
          <p className="mt-6 text-lg text-slate-400 leading-relaxed">
            Choose the right TallyPrime edition for your business — Silver, Gold, or Enterprise. Add cloud hosting for remote access and seamless multi-location operations.
          </p>
        </motion.div>
