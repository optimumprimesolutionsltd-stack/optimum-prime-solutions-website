      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{once:true}} variants={{visible:{transition:{staggerChildren:0.15}}}}>
            ...
            >
              About Optimum Prime Solutions Ltd
            </motion.span>
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-black/40">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="space-y-4">
                  {[{icon:Target,title:'Our Mission',text:c.mission},{icon:Eye,title:'Our Vision',text:c.vision},{icon:Zap,title:'Why Choose Us',text:'Kenya\'s certified TallyPrime reseller, business systems consultant, and cloud hosting provider — with responsive support and solutions built for the Kenyan market.'}].map(({icon:Ic,title,text})=>(
