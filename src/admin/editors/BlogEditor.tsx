          ...
          {exp === b.id && (
            <div className="border-t border-navy-100 p-5 space-y-4">
              ...
              <div className="border-t border-navy-100 pt-4">
                ...
                <p className="mt-1.5 text-xs text-navy-500">Sends immediately, ignoring the schedule above. Save the post first — this sends whatever's currently saved, not unsaved edits.</p>
              </div>
            </div>
          )}
        </div>
